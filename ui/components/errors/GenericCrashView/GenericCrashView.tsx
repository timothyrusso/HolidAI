...
import { useGenericCrashViewLogic } from '@/ui/components/errors/GenericCrashView/GenericCrashView.logic';
import { styles } from '@/ui/components/errors/GenericCrashView/GenericCrashView.style';
