...
- [2026-09-09] Testing edge tap targets with separate `agent-browser mouse move/down/up`
  ...
  legitimate edge taps (e.g. a pressable grown 4px past its visual edge, the web-safe replacement
  for `hitSlop`, which react-native-web ignores) falsely appear to miss. Use
